...
class OAuthService {
    ...
    static Request(url, method, params) {
        ...
        if (maybeAuth) {
            ...
            let _params = {};
            let headers = (params === null || params === void 0 ? void 0 : params.headers) || {};
            headers[`Authorization`] = Utilities.formatString(`Bearer %s`, this.token);
            _params[`headers`] = headers;
            let methodFromParams = (params === null || params === void 0 ? void 0 : params.method) || `get`;
            _params[`method`] = method || methodFromParams;
            let muteHttpExceptions = (params === null || params === void 0 ? void 0 : params.muteHttpExceptions) || true;
            ...
            if (code >= 200 && code < 300) {
                ...
                console.error("Backend server error (%s): %s", code.toString(), res.getContentText("utf-8"));
